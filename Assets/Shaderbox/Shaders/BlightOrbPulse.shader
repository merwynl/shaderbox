...
Shader "BlightOrbPulse"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_Intensity( "Intensity", Range( 0, 10 ) ) = 1
		_ColourInner( "Colour Inner", Color ) = ( 1, 0.2509804, 0.5254902, 0 )
		_ColourOuter( "Colour Outer", Color ) = ( 1, 0.4103774, 0.7869949, 0 )
	...
	SubShader
	{
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(BlightOrbPulse)
				UNITY_DEFINE_INSTANCED_PROP(float4, _ColourInner)
				UNITY_DEFINE_INSTANCED_PROP(float4, _ColourOuter)
			...
			UNITY_INSTANCING_BUFFER_END(BlightOrbPulse)
						 ...
						 ) : SV_Target
			{
				...
				float4 _ColourInner_Instance = UNITY_ACCESS_INSTANCED_PROP(BlightOrbPulse,_ColourInner);
				float4 _ColourOuter_Instance = UNITY_ACCESS_INSTANCED_PROP(BlightOrbPulse,_ColourOuter);
				float _Scale_Instance = UNITY_ACCESS_INSTANCED_PROP(BlightOrbPulse,_Scale);
				float _Power_Instance = UNITY_ACCESS_INSTANCED_PROP(BlightOrbPulse,_Power);
				float fresnelNdotV22 = dot( NormalWS, ViewDirWS );
				float fresnelNode22 = ( 0.0 + _Scale_Instance * pow( 1.0 - fresnelNdotV22, _Power_Instance ) );
				float4 lerpResult23 = lerp( _ColourInner_Instance , _ColourOuter_Instance , fresnelNode22);
				
				float _Intensity_Instance = UNITY_ACCESS_INSTANCED_PROP(BlightOrbPulse,_Intensity);
				...
				float Occlusion = 1;
				float3 Emission = ( lerpResult23 * (  (0.0 + ( sin( _TimeParameters.x ) - -1.0 ) * ( 1.0 - 0.0 ) / ( 1.0 - -1.0 ) ) * _Intensity_Instance ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19908
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;-688,208;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;19;-1328,240;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;-1952,240;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;16;-2288,240;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;18;-1728,240;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;14;-1808,480;Inherit;False;InstancedProperty;_Intensity;Intensity;0;0;Create;True;0;0;0;False;0;False;1;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;23;-1008,-400;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FresnelNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;22;-1408,-64;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;24;-1392,-544;Inherit;False;InstancedProperty;_ColourInner;Colour Inner;1;0;Create;True;0;0;0;False;0;False;1,0.2509804,0.5254902,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;25;-1392,-320;Inherit;False;InstancedProperty;_ColourOuter;Colour Outer;2;0;Create;True;0;0;0;False;0;False;1,0.4103774,0.7869949,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;27;-1648,64;Inherit;False;InstancedProperty;_Power;Power;3;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;26;-1648,-32;Inherit;False;InstancedProperty;_Scale;Scale;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=586E8FDC567A6EE579D5F86B17F77C344D4140F3